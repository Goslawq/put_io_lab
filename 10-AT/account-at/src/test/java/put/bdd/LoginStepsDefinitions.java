...
public class LoginStepsDefinitions {
	...
	public void iHaveMovedToTheRegisterPage() {
		mainPage.openPage();
		mainMenu.clickRegisterLink();
	}
	...
	@When("^I fill the register form with username \"([^\"]*)\" and password \"([^\"]*)\", repeat password \"([^\"]*)\", name \"([^\"]*)\", address \"([^\"]*)\" and I submit it$")
	public void iFillTheRegisterFormWithUsernameAndPasswordRepeatPasswordNameAddressAndISubmitIt(String username, String password, String repeat_password, String name, String address) throws Throwable {
		registrationPage.registerUser(username, password, repeat_password, name, address);
	}
}
