...
formatter.uri("src/test/resources/put/bdd/register.feature");
formatter.feature({
  "name": "Register.",
  "description": "",
  "keyword": "Feature"
...
formatter.step({
  "name": "I have moved to the register page",
  "keyword": "Given "
});
formatter.match({
  "location": "LoginStepsDefinitions.iHaveMovedToTheRegisterPage()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "I fill the register form with username \"jan\" and password \"jan\", repeat password \"jan\", name \"jan\", address \"ul. Kolorowa\" and I submit it",
  "keyword": "When "
});
formatter.match({
  "location": "LoginStepsDefinitions.iFillTheRegisterFormWithUsernameAndPasswordRepeatPasswordNameAddressAndISubmitIt(String,String,String,String,String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "LoginStepsDefinitions.iShouldSeeTheLoginPage()"
});
formatter.result({
  "status": "passed"
});
